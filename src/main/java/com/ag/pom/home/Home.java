...
public class Home extends BasePage {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.ag.pom.home.Home.class);

    @FindBy(css = "a[class^='hero_btn-main']")
    ...
    public void goTo() {
        this.driver.get("https://attila-gyori.com/home");
    }
    ...
    public void pressContact() {
        this.wait.until((d) -> this.buttonContact.isDisplayed());
        this.buttonContact.click();
    }
